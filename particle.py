...
class particle:
    def __init__(self, x_boundary, y_boundary, color=BLUE, size_range=(10, 11), max_ini_speed=4):
    ...
    def move(self):
        """Essentially, bouncing from the walls. Don't pay attention to the boolean mess right underneath. I just hate if conditions :)"""
